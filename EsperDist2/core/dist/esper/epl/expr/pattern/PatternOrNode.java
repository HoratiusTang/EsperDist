...
public class PatternOrNode extends PatternMultiChildNode{
	
	public PatternOrNode() {
		super();
	}

	public PatternOrNode(EvalOrFactoryNode factoryNode, AbstractPatternNode parent){
	...
	public PatternPrecedenceEnum getPrecedence() {
		return PatternPrecedenceEnum.OR;
	}
}
