...
public class EventGeneratorFactory2 {
	...
	public static EventInstanceGenerator genEventInstanceGenerator(String eventName){
		...
		eventGen.addProperty("in0", new FieldGeneratorFactory.IntegerNormalGenerator(100, 20, 0, 200));
		eventGen.addProperty("in1", new FieldGeneratorFactory.IntegerNormalGenerator(200, 30, 0, 400));		
		...
		eventGen.addProperty("iu0", new FieldGeneratorFactory.IntegerUniformGenerator(100, 200));
		eventGen.addProperty("iu1", new FieldGeneratorFactory.IntegerUniformGenerator(0, 300));
		eventGen.addProperty("dn0", new FieldGeneratorFactory.DoubleNormalGenerator(200, 30, 0, 400));
		eventGen.addProperty("dn1", new FieldGeneratorFactory.DoubleNormalGenerator(300, 49, 0, 600));
